...
ImageButton.Image = "http://www.roblox.com/asset/?id=13700678418"
...
_G.WindowBackgroundColor = Color3.fromRGB(255,0,0)
...
local osfunc = {}
 ...
 WindowStrokemain.Archivable = true
	...
	Logo.Image = "rbxassetid://15388425623"
...
local Library = Update:Window("Min XT Hub")
local Main = Library:Tab("Main","rbxassetid://6026568198")
local M = Library:Tab("Item","rbxassetid://7251993295")
...
Main:Toggle("Auto Farm Chest Hop",_G.AutoFarmChest_Hop,function(value)
    ...
    Main:Toggle("Auto Spawn",false,function(value)
...
Main:Toggle("Fast Attack Super",true,function(value)
...
spawn(function()
                    ...
                    pcall(function()
                        ...
                        if MyLevel >= 700 and World1 then
                            if game:GetService("Workspace").Map.Ice.Door.CanCollide == false and game:GetService("Workspace").Map.Ice.Door.Transparency == 1 then
                                ...
                                if game:GetService("Workspace").Map.Ice.Door.CanCollide == false and game:GetService("Workspace").Map.Ice.Door.Transparency == 1 then
                                    if game:GetService("Workspace").Enemies:FindFirstChild("Ice Admiral [Lv. 700]") then
                                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                            if v.Name == "Ice Admiral [Lv. 700]" then
                                        ...
                                        if game:GetService("ReplicatedStorage"):FindFirstChild("Ice Admiral [Lv. 700]") then
                                            topos(game:GetService("ReplicatedStorage"):FindFirstChild("Ice Admiral [Lv. 700]").HumanoidRootPart.CFrame * CFrame.new(5,10,7))
                                        end
                                    end
                                end
                            end
    ...
    elseif World3 then
        M:Toggle("Auto Mystic Island",getgenv().TPMystic,function(value)
...
spawn(function()
        while wait() do
            if _G.Makori_gay and World2 then
                pcall(function()
                    if game:GetService("Workspace").Enemies:FindFirstChild("Water Fighte") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
...
spawn(function()
   ...
   M:Seperator("Misc Mastery")
    ...
    M:Toggle("Auto Farm Fruit Mastery",_G.AutoFarmFruitMastery,function(value)
            ...
            while wait(.1) do
                if _G.AutoBartilo then
                    ...
                    elseif game:GetService("Players").LocalPlayer.Data.Level.Value >= 800 and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress","Bartilo") == 1 then
                        if game:GetService("Workspace").Enemies:FindFirstChild("Jeremy [Lv. 850]") then
                            Ms = "Jeremy [Lv. 850]"
                            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                if v.Name == Ms then
                        ...
                        elseif game:GetService("ReplicatedStorage"):FindFirstChild("Jeremy [Lv. 850]") then
                            repeat topos(CFrame.new(-456.28952, 73.0200958, 299.895966)) wait() until not _G.AutoBartilo or (game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-456.28952, 73.0200958, 299.895966)).Magnitude <= 10
                            wait(1.1)
...
spawn(function()
    ...
    T:Button("Bypass Teleport",function()
		 _G.Instant = true
